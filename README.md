...
>
> If you want to add new language, send in issues those two translated files: [FILE 1](https://github.com/masagrator/Status-Monitor-Deux/blob/main/config/status-monitor-deux/locale.ini), [FILE 2](https://github.com/masagrator/Status-Monitor-Deux/blob/main/docs/toTranslate.ini)
